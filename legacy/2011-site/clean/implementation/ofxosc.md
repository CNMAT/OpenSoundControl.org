...
[ofxOsc](http://www.frey.co.nz/projects/ofxosc)
:::
:::
:::
...
::: {.field-items}
::: {.field-item}
ofxOsc is an add-on for the [openFrameworks](http://openframeworks.cc/)
system that allows OSC communication. it is built on Ross Bencina\'s
oscpack.
:::
:::
:::
