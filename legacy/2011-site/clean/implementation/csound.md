...
<http://www.csounds.com/manual/html/OSCNetwork.html>
:::
:::
:::
...
::: {.field-items}
::: {.field-item}
OSC enables interaction between different audio processes, and in
particular between Csound and other synthesis engines. The following
