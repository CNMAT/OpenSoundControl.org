...
<http://ross.smartelectronix.com/index.cgi/browser/oscpack/trunk/README>
:::
:::
:::
...
framework, it doesn\'t include infrastructure for constructing or
routing OSC namespaces, just classes for easily constructing, sending,
receiving and parsing OSC packets. The library should also be easy to
use for other transport methods (eg serial).
:::
:::
:::
