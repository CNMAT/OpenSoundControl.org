...
[http://opensoundcontrol.org/implementation/open-sound-control-php](implementation/open-sound-control-php)
:::
:::
:::
...
communication (i.e. sending of messages).

Changelog:\
Version 0.2: March 22, 2007. Fixes a bug in timetag encoding for
bundles.\
...
:::
  ...
  Attachment                   Size
  ---------------------------- ----------
  [OSC.phps](files/OSC.phps)   17.49 KB
:::
