...
<http://www.sciss.de/netutil/doc/api/index.html>
:::
:::
:::
...
::: {.field-items}
::: {.field-item}
NetUtil is a compact java library for sending and receiving messages
using the OpenSoundControl protocol over UDP. Requirements: Java 1.4+ ;
License: LGPL
:::
:::
:::
